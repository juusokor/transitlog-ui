  ...
  var b = function(a) {
      ...
      function c(b) {
        for (var c = 0; c < b.length; c++) {
          for (var e = !0, f = 0; f < b[c].test.length; f++)
            if (b[c].test[f] instanceof RegExp) {
          ...
          if (g.hasOwnProperty(b) && a[b]) {
            if (a[b].$version) {
              ...
              if (c) {
                ...
                if (
                  ((a[b].version = c),
                  d[0] && (a[b].majorVersion = parseInt(d[0])),
                  d[1] && (a[b].minorVersion = parseInt(d[1])),
                  d[2] && (a[b].patchVersion = parseInt(d[2])),
                  h)
                )
            ...
            for (var m in a[b])
              a[b].hasOwnProperty(m) && "$" !== m[0] && (f[b][m] = a[b][m]);
          }
      }
      function e(b) {
        var c;
        ...
        var d = a.indexOf(c);
        if (-1 != d) {
          var e = a.substring(d + c.length),
            f = /^(\d+(\.|_)){0,2}\d+/.exec(e);
          if (f) return f[0].replace(/_/g, ".");
        }
      }
      var f = {
          browser: {
